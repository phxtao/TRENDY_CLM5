...
save([data_path, 'trendy_clm5/output_data/da_reconstruct/trendy_clm5_global_reconstruct_s3_matrix_', num2str(sd_controling_factor), '_worker_', num2str(iworker), '_parameters_keep2.mat'], 'parameters_keep2', '-v7.3');

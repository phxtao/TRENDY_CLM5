...
litter_allo_ratio = nan(year_size*month_num, 4);
% env. scalars
...
for iyear = 1 : year_size
    for imonth = 1 : month_num
        ...
        litter_allo_ratio((iyear-1)*12+imonth, :) = [input_tot_cwd, input_tot_litter1, input_tot_litter2, input_tot_litter3]/carbon_input;
